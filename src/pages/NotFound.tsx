...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center p-8">
      <div className="w-full max-w-125 rounded-xl border border-white/10 bg-slate-900/60 p-8 text-center shadow-2xl backdrop-blur-md">
        ...
        <p className="text-sm text-slate-400 leading-relaxed mb-8">
          The system path you requested does not exist or has been shifted
          across the stellar network. Let's get you back on track.
        </p>
